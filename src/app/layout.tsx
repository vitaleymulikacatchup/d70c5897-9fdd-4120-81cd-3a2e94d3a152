...
export const metadata: Metadata = {
  title: "F1 Teams Hub - Complete Formula 1 Teams Database",
  description: "Discover comprehensive information about all Formula 1 teams, drivers, statistics, and racing history. Your ultimate resource for F1 team data and insights.",
  keywords: "Formula 1, F1 teams, racing database, motorsport, drivers, team statistics, F1 analytics",
  ...
  openGraph: {
    ...
    images: [{
      url: "https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_34kFQ1mvageIxtFsoHwjFOCooyh/uploaded-1763644327626-8puxpdnw.jpg",
  ...
  twitter: {
    ...
    title: "F1 Teams Hub - Complete Formula 1 Teams Database",
    description: "Discover comprehensive information about all Formula 1 teams, drivers, statistics, and racing history.",
    images: ["https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_34kFQ1mvageIxtFsoHwjFOCooyh/uploaded-1763644327626-8puxpdnw.jpg"]
  },
  robots: {
    index: true,
    follow: true
